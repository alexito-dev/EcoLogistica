...
- Next.js + Tailwind entrega una aplicación web responsive, incluido el modo conductor.
- Nest.js expone la API REST principal y aplica autenticación, autorización y reglas transaccionales.
- Python + OR-Tools ejecuta VRPTW/Green VRP como servicio desacoplado del ciclo HTTP; puede operar como proceso de trabajo.
...
flowchart TB
    ...
    subgraph eco["Sistema EcoLogística Huancayo"]
      web["Contenedor: Aplicación web/PWA<br/>Next.js + Tailwind + Leaflet<br/>UI, caché controlada y modo conductor"]
      api["Contenedor: API principal<br/>TypeScript + Nest.js<br/>REST, autenticación, RBAC, validación y orquestación"]
      worker["Contenedor: Servicio de optimización<br/>Python + OR-Tools<br/>VRPTW/Green VRP y reoptimización"]
...
| API Nest.js | Contratos, validación, RBAC, casos de uso y auditoría | No mantiene estado de sesión en memoria | Réplicas horizontales; health checks |
...
flowchart LR
    ...
    subgraph api["Contenedor: API Nest.js"]
...
flowchart LR
    ...
    app["Servicio de aplicación<br/>Nest.js"]
...
|---|---|---|---|
| ADR-01 | Monolito modular Nest.js para el PMV | Equipo de cinco y 14 semanas | Menor complejidad operativa; límites internos estrictos para extraer el optimizador después |
...
| RES-06 / RES-19 | Next.js, Nest.js, Python, PostgreSQL/PostGIS, Leaflet/OSM y separación por contenedores |
| RES-21 | tácticas OWASP, WCAG, Green Software e ISO 14083 |

## 11. Verificación arquitectónica

1. Prueba de contrato OpenAPI entre Next.js y Nest.js.
