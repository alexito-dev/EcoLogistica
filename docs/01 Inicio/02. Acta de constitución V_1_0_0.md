...
1. **Stack tecnológico obligatorio (RES-06):** Python con Django y TypeScript con Nest.js en el backend, React con Next.js y Tailwind CSS en el frontend, PostgreSQL como base de datos y Leaflet/OpenStreetMap para cartografía.
