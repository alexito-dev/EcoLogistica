...
| RST-ECO-02 | Acceso sin licencias propietarias | Stack principal abierto: Next.js, Nest.js, Python, PostgreSQL/PostGIS y Leaflet/OSM. | Dependencia y costo no previstos. | Inventario SBOM/licencias y revisión de compatibilidad. | Arquitectura + QA | SBOM y matriz de licencias. | 100 % dependencias inventariadas; 0 licencias incompatibles. | Alta |
